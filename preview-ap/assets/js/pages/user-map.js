...
function getIcon(iconScale){
    ...
    let iconConfig = {
        iconUrl: "/web-preview/preview-ap/assets/images/icons/star_red.svg",
        iconSize: iconSize,
        iconAnchor: [iconSize[0]*.5, iconSize[1]],
        shadowUrl: "/web-preview/preview-ap/assets/images/icons/small_shadow.svg",
...
async function get_manual_values() {
    let response = await fetch("/web-preview/preview-ap/assets/data/htcss-users.json")
