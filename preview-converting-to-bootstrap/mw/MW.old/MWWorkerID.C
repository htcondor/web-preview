...
/** This static array is used to hold strings that represent the
    ...
    @see MWworker_states */
static char* MWworker_statenames[] = {
    "INITIALIZING",
    "IDLE",
...
int *MWWorkerID::vids = new int[1024];  /* 1024 workers enough for now! */
...
void MWWorkerID::printself( int level ) 
{
    ...
    MWprintf ( level, "id1: %x id2: %x, vid: %d, name: \"%s\"\n",
...
void MWWorkerID::ckpt_stats( double *up, double *working, 
